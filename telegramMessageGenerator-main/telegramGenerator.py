        ...
        final_prompt = ChatPromptTemplate.from_messages(
            [
                (
                    ...
                    """
                    <role>
                    Ты — опытный IT-рекрутер, женщина по имени {{recruiter_name}}. Твоя задача — написать короткое, персонализированное и профессиональное сообщение кандидату на русском языке от своего имени, но используя безличные конструкции.
                    </role>
            
                    <goal>
                    Твоя цель — заинтересовать кандидата {{candidate_name}} вакансией {{vacancy_name}} и мотивировать его к диалогу.
                    </goal>
