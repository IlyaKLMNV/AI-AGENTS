...
class ResumeGenerator(Generator):
    ...
    def instruction(self, spec: ResumeSpec) -> str:
        return (
            "Ты пишешь реалистичный текст резюме IT-кандидата на русском (обычный текст, без markdown).\n"
            "ОБЯЗАТЕЛЬНО явно упомяни в навыках/опыте ВСЕ технологии из must_mention.\n"
            "КАТЕГОРИЧЕСКИ НЕ упоминай ни одной технологии из must_not_mention (ни прямо, ни намёком).\n"
            "Резюме: 2-4 предложения про опыт + строка «Навыки: ...». Не выдумывай технологии сверх "
            "перечисленных в must_mention (можно общие слова про опыт)."
        )
