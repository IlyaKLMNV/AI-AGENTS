...
class CandidateAgent:
    ...
    def _instruction(self) -> str:
        return (
            ...
            "- Пиши как РЕАЛЬНЫЙ человек в мессенджере: живой разговорный русский, КОРОТКО и по делу.\n"
            "  БЕЗ литературных красивостей, метафор, поэзии и витиеватых сравнений (никаких «манна\n"
            "  небесная», «телефон загадочно молчит», стихов и т.п.) — обычная бытовая реплика."
        )
