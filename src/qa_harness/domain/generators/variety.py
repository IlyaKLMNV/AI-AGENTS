...
# Объём — реалистичный для мессенджера (даже «развёрнуто» ≤ 2-3 коротких предложения, без простыней).
VERBOSITY = ["очень коротко, одной фразой", "коротко, 1-2 предложения", "чуть развёрнуто, 2-3 коротких предложения"]
