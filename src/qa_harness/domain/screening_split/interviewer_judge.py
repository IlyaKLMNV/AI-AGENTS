...
EVAL_INSTRUCTION = (
    ...
    "переноси требования (вопросы/факты) из инструкции одного хода на другой: вопрос, заданный в предыдущем "
    "ходе, в следующем повторять НЕ требуется. Верни общий вердикт.\n"
